class EpisodesController < ApplicationController
  before_action :authenticate_podcast!, expcet: [:show]
  ...
  def update
    if @episode.update episode_params
      redirect_to podcast_episode_path(@podcast, @episode), notice: "EL episodio fue actualizado satisfactoriamente!"
    else
      render 'edit'
    end
  end
  ...
  def require_permission
    ...
    if current_podcast != @podcast
      redirect_to root_path, notice: "Lo siento, no tienes acceso para ver esta pagina"
    end
  end
end
